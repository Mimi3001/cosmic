...
const animalPools = {
  ...
  1: {
    ...
    pale: false,
    dark: false,
    sky:   [[14,3],[18,3],[39, 3],[17,2],[23,1]],
    water: [[5,5],[11,2],[15,2],[4,2],[17,1],[16,3],[22,1],[21,1]],
    land:  [[6,5],[7,3],[8,1],[9,4],[13,3],[12,1],[10,3],[38,3],[40,4],[21,1]]
  },
  ...
  2: {
    ...
    water: [[5,5],[11,2],[15,2],[4,3],[39,4],[21,1]],
    land:  [[6,2],[7,1],[8,2],[9,2],[13,5],[12,3],[10,1], [25,5],//iguana
  ...
  3: {
    ...
    pale: false,
    dark: false,
    sky:   [[14,3],[18,4],[17,2],[23,3],[24,2],[26,4],[28,1],[39, 4]],
    water: [[5,5],[11,2],[15,2],[4,4],[16,3],[22,4],[29,5],[39,3],[20,1],[21,1]],
    land:  [[6,3],[7,2],[8,1],[9,4],[13,3],[12,1],[10,2],
            [19,2],[20,2],[21,2],[25,4],[27,3],[30,3],
  ...
  4: {
    ...
    pale: false,
    dark: false,
    sky:   [[14,3],[18,3],[39, 4],[17,3],[24,1]],
    water: [[5,4],[11,2],[15,2],[4,2],[16,2],[21,2]],
    land:  [[6,4],[7,4],[8,2],[9,4],[13,3],[12,2],[10,2],[33,2],[34,1][38, 2],[39, 2],[40, 4],[20,1],[21,1],[19,1]]
  },
  ...
  5: {
    ...
    water: [[5,3],[11,2],[15,3],[4,1],[21,4],[22,3],[19,1]], // seal common
  ...
  7: {
    ...
    pale: false,
    dark: true,
    sky:   [[14,2],[18,3],[17,2],[23,4],[24,4],[26,2],[39, 4],[28,4]], // parrots,birds,insects boosted
    water: [[5,4],[11,3],[15,4],[4,4],[16,3],[22,4],[39, 4],[29,3],[20,2],[21,2]],   // tropical fish, blue frog boosted
    land:  [[6,2],[7,2],[8,2],[9,2],[13,2],[12,1],[33,3],[39, 2],[38, 3],[40, 4],[10,3],
            [25,4],[27,4],[30,4],[32,2][36,45],[37,3]]  // iguana, leopard, giraffe
  }
};
...
function handleAnimalClick(x, y) {
  ...
  if (currentAnimalClass === "random") {
    ...
    if (zone === "sky") type = 14;
      ...
      ? [[19,5],[6,3],[7,2],[8,1]]   // polar bear boosted on Ahra
      : pool.land.filter(([t]) => [6,7,8,16,19,21,27,31,32,33,36,37].includes(t)).concat([[6,3]])
    );
